...
def helmConfig(tiller, helm_repo) {
    ...
    sh "export AWS_REGION=\'eu-west-1\' && helm repo add ${helm_repo} s3://${helm_repo} --tiller-namespace ${tiller} && helm s3 reindex giffgaff-charts --acl=\'bucket-owner-full-control\'"
}
